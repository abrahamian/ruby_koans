...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # In simple cases it would never fail to match.
  end
  ...
  # They try to match as much as possible in the string
  ...
  # Character class matches any single character of the appropriate type.
  # Alternation can be used to match a custom set of strings
