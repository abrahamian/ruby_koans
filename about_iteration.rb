...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # It takes an argument and a block. The block is executed for each element in the array that calls the method.
    # The first time it is executed, the first argument to the block ('sum' or 'product' in the examples above) is equal to the argument passed to the method.
    # The return value of the block is the value of that first argument, each subsequent time it is executed.    

    # some very good examples here: http://blog.jayfields.com/2008/03/ruby-inject.html
